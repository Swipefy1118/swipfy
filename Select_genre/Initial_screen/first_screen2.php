...
$redirectUri = urlencode('http://localhost:3000/spotify_callback.php'); // ここを新しいファイルに合わせる
// 必要なスコープをすべて含める（streaming, user-modify-playback-state, user-read-currently-playing）
$scopes = urlencode('streaming user-modify-playback-state user-read-currently-playing');
...
<script>
    ...
    // ---------------------------------------------
    // 個人のトークンを取得してここに貼る
    const token = 'BQBR7DL7pu7Q5jZsMhgmTN2WiFHMtZfONAIQWBS2GqUF3cXrerdwtOHi0B86pieIXrLz-p95OQln2O-mvDNgEDM1TKkP7641UOgleBjcNRu8S29E9qN5OH5mK5lp0MHtwu3AM3E6iYp19_GwUK-6Sm6XedatK6Jbr7Kz3V3kNBw4nX1veTQbY77p9s5QPQa9Ib3cjeaXjFn6CXL8kkk8_TeimQB3-_UiITZnkf8APsKF-2qYlehAA7kMisMLWoRiyVphi56ISouSOjjl-hg0U5ioCIemCuIFMFa9qkcBVo0QSZ01012frxyTNPN9aMxEd4BW'; 
